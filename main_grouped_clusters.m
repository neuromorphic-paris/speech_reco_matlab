...
spikes_feature_train = assign_closest_center_window(spikes_feature_train, centers, metric_dist_assignement);
...
all_train_context2 = aggregate_contexts_window(spikes_feature_train, specs_layer2);
...
ctx_to_discard2 = (sum(all_train_context2 > ...
  exp(-thresh_too_far_event2/specs_layer2.tau), 2) / size(all_train_context2, 2)) ...0
   < ratio_empty_ctx2;
...
metric_dist_assignement = 'cosine';
spikes_train2 = assign_closest_center_window(spikes_train, centers2, metric_dist_assignement);
spikes_test2 = assign_closest_center_window(spikes_test, centers2, metric_dist_assignement);
...
spikes_feature_train = assign_closest_center_window(spikes_feature_train, centers2, metric_dist_assignement);
for ind = 1:numel(spikes_feature_train)
  spikes_feature_train{ind}.validity = spikes_feature_train{ind}.dist_closest_center < thresh_dist_validity;
end
all_train_context3 = aggregate_contexts_window(spikes_feature_train, specs_layer3);
...
metric_dist_assignement = 'cosine';
spikes_train3 = assign_closest_center_window(spikes_train2, centers3, metric_dist_assignement);
spikes_test3 = assign_closest_center_window(spikes_test2, centers3, metric_dist_assignement);
