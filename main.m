...
specs_layer2.tau = 5000; % tau is an exponential decay, in microseconds
...
ratio_empty_ctx2 = 0.3/nb_clusters; % below this ratio the context will be discarded
nb_clusters2 = 64;

ctx_to_discard2 = sum(all_train_context2 > ...
  exp(-thresh_too_far_event2/specs_layer2.tau), 2) ...
  < ratio_empty_ctx2;
...
specs_layer3.tau = 25000; % tau is an exponential decay, in microseconds
...
ratio_empty_ctx3 = 0.3/nb_clusters2; % below this ratio the context will be discarded
nb_clusters3 = 256;

ctx_to_discard3 = sum(all_train_context3 > ...
  exp(-thresh_too_far_event3/specs_layer3.tau), 2) ...
  < ratio_empty_ctx3;
